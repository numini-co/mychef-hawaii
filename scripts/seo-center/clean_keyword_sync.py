#!/usr/bin/env python3
"""
clean_keyword_sync.py
Updates the primary keywords in NEO by looking up the keyword first.
"""
import psycopg2
...
def main():
    ...
    conn.commit()
    print(f"\nAll {count} primary commercial keywords successfully locked in NEO!")
    cur.close()
    conn.close()
