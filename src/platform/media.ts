...
const ALT: Record<string, string> = {
  ...
  'hub/service-events': 'Intimate garden wedding reception dinner our team catered on a Hawaiian estate at night',
  'hub/multi-island-itinerary': 'A chef’s kit and first course on a villa table — the start of a multi-island itinerary we staff as one brief',
  'hub/island-oahu-card': 'Private penthouse dinner our team cooked in Honolulu — city lights and the ocean at blue hour',
  'hub/island-maui-card': 'A multi-course anniversary dinner our chefs prepared on an oceanfront Wailea villa lānai',
  'hub/island-kauai-card': 'A private estate wedding dinner our chef team catered on a plantation veranda in Hanalei',
  'hub/island-bigisland-card': 'Hand-plated local catch finished by our chef at an intimate dinner on the Kona coast',
  'hub/pedigree-discretion': 'A discreet two-seat villa dinner our chef plated at night — the same kitchen standard we hold for high-demand rooms',
  'hub/service-retreats': 'Morning retreat table where our chef served a communal breakfast for a wellness group on a Kauaʻi estate',
  'hub/service-corporate': 'Executive board dinner our culinary team cooked and served in a private Honolulu residence',
  'hub/service-bar': 'Staffed bar cart our team ran on a villa lānai at dusk for a private Hawaii gathering',
  'hub/service-staffing': 'Servers placing plated courses at a candlelit villa dinner our team staffed on a Hawaiian estate',
  'hub/rate-card-quote': 'Written quote packet our desk prepares before any date is locked — itemized, confirmed total',
  'hub/honesty-folio': 'Event folio and grocery receipts we keep for Stay Chef clients — the numbers on their own lines',
  'hub/guides-planning': 'Our chef planning a villa week from that morning’s market produce — the same notes behind the public guides',
  'hub/cta-take-the-table': 'Our chef placing the first course on a villa table at dusk — the moment a written quote becomes dinner',
  'hub/trust-claims-desk': 'Written quote packet and chef kit on a Hawaiian villa kitchen island — published numbers before any date is locked',
  'hub/faq-guest-brief': 'Our chef walking a villa table through the written brief before service — the same questions the desk answers first',
...
const SETS: Record<SiteId, Record<string, string[]>> = {
  hub: {
    ...
    body: [
      ...
      'hub/service-events',
      'hub/service-retreats',
      'hub/service-corporate',
      'hub/service-stay-chef',
      'hub/service-bar',
      'hub/service-staffing',
      'hub/cta-take-the-table',
      'hub/trust-claims-desk',
    ],
  },
  oahu: {
